 ## Author : Yaovi SAMAH
 ## Author Url : https://yaovisamah.com
# import all modules
from tkinter import *
...
conn = sqlite3.connect('C:\\Users\YAOVI SAMAH\Videos\EVA\\NUSRONPE\PYTHON-CODE\store.db')
c = conn.cursor()
# date
...
class Application:
    def __init__(self, master):
        ...
        # components
        self.heading = Label(self.left, bg='white', text='Products System', font=('arial 40 bold'))
    ...
    def change(self):
        ...
        # label change .....
        self.c_amount = Label(self.left, text="Change: KSH. " + str(self.to_give), font=('arial 18 bold'), fg='red', bg='white')
        self.c_amount.place(x=0, y=600)

    def generate_bill(self):
        # create the bill before updating......
        directory = "C:/Users/YAOVI SAMAH/Videos/EVA/NUSRONPE/PYTHON-CODE/Invoice/" + str(date) + "/"
        if not os.path.exists(directory):
            os.makedirs(directory)

        # Templates for the bills
        company = "\t\t\t\tProducts System.\n"
        address = "\t\t\t\tKumasi, Ghana.\n"
        phone = "\t\t\t\tMobile No: 0554335366.\n"
        sample = "\t\t\t\t\tInvoice.\n"
        dt = "\t\t\t\t" + str(date)
        ...
        for t in products_list:
            ...
            r += 1
        teller = "James"
        f.write("\n\n\t\t\tTotal: KSH. " + str(sum(products_price)))
        f.write("\n\n\t\t\tChange: KSH. " + str(str(self.to_give)))
...
class Login:
    def __init__(self, master):
        ...
        self.Label1.configure(background="#0066ff", borderwidth="0", disabledforeground="#a3a3a3", font=font11, foreground="#ffffff", text='''Products System''', width=154)
...
root = Tk()
Login(root)
root.title("Products System")
root.iconbitmap(r'productcollections.icon')
